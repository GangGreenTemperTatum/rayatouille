...
// KeyMap defines keybindings specific to the actors list view.
type KeyMap struct {
...
func (k KeyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.StatusAll, k.StatusAlive, k.StatusDead, k.StatusPending, k.Sort, k.Filter, k.Enter}
}

// FullHelp returns keybindings grouped for the full help view.
func (k KeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.StatusAll, k.StatusAlive, k.StatusDead, k.StatusPending},
		{k.Sort, k.Filter, k.Enter},
	}
}

// Keys is the default set of actor-specific keybindings.
var Keys = KeyMap{
...
func ApplyBindings(b config.ActorsBindings) {
